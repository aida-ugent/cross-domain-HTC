...
model_dir=models/${data_name}/${model_name}_seed${seed}
mkdir -p ${model_dir}

params_dir=params/${data_name}/${model_name}

mkdir -p models/${data_name}/${model_name}
...
python3 -m pecos.xmc.xtransformer.train \
                                ...
                                --model-dir ${model_dir} \
                                --saved-trn-pt models/${data_name}/${model_name}/X_trn.pt \
                                --saved-val-pt models/${data_name}/${model_name}/X_val.pt \
